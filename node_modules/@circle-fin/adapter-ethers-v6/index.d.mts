 ...
 */
interface CreateEthersAdapterFromPrivateKeyParams<TCapabilities extends Partial<AdapterCapabilities> = AdapterCapabilities> {
    /**
...
/**
 * @deprecated Use {@link CreateEthersAdapterFromPrivateKeyParams} instead.
 *
 * Parameters for creating an {@link EthersAdapter} from a private key.
 *
 * @typeParam TCapabilities - The adapter capabilities type for compile-time address validation
 */
type CreateAdapterFromPrivateKeyParams<TCapabilities extends Partial<AdapterCapabilities> = AdapterCapabilities> = CreateEthersAdapterFromPrivateKeyParams<TCapabilities>;
/**
 ...
 * ```
 */
declare function createEthersAdapterFromPrivateKey<const TCapabilities extends Partial<AdapterCapabilities> = object>(params: CreateEthersAdapterFromPrivateKeyParams<TCapabilities>): EthersAdapter<InferAdapterCapabilities<TCapabilities>>;
/**
 ...
 * ```
 */
declare const createAdapterFromPrivateKey: typeof createEthersAdapterFromPrivateKey;

/**
 * Parameters for creating an {@link EthersAdapter} from an EIP-1193 provider.
 *
 * @interface CreateEthersAdapterFromProviderParams
 * @category Types
 * @description
...
/**
 * @deprecated Use {@link CreateEthersAdapterFromProviderParams} instead.
 *
 * Parameters for creating an {@link EthersAdapter} from an EIP-1193 provider.
 *
 ...
 * ```
 */
type CreateAdapterFromProviderParams = CreateEthersAdapterFromProviderParams;
/**
 ...
 * ```
 */
declare const createEthersAdapterFromProvider: (params: CreateEthersAdapterFromProviderParams) => Promise<EthersAdapter>;
/**
 ...
 * ```
 */
declare const createAdapterFromProvider: (params: CreateEthersAdapterFromProviderParams) => Promise<EthersAdapter>;
...
export type { ChainIdentifier, CreateAdapterFromPrivateKeyParams, CreateAdapterFromProviderParams, CreateEthersAdapterFromPrivateKeyParams, CreateEthersAdapterFromProviderParams, EIP2612Message, EIP2612NonceFetcher, EIP2612Options, EthersAdapterOptions, PermitStandardName, Signature, TypedData, TypedDataField };
