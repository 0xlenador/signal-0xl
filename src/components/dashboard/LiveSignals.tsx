...
export default function LiveSignals() {
  ...
  useEffect(() => {
    ...
    const addSignal = () => {
      ...
      } else if (eventText.includes('RUNESTONE') || eventText.includes('AGENT')) {
        typeClass = 'text-fuchsia-400';
  ...
  return (
    <div className="w-full mt-8 h-64 shrink-0 flex flex-col bg-black/60 rounded-xl border border-slate-800/80 p-3 overflow-hidden relative z-10 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]">
      <div className="text-[0.55rem] font-bold text-slate-300 uppercase tracking-widest mb-2 flex items-center justify-between">
