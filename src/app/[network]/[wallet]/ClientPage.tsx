    ...
    <main className="p-4 md:p-6 lg:p-8 w-full mx-auto flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 items-start">
        ...
        <div className="xl:col-span-4 flex flex-col gap-4">
          ...
          <div className="bg-slate-950 rounded-[2.5rem] border border-slate-800 shadow-xl relative flex flex-col p-5 justify-between flex-grow group hover:shadow-[0_0_40px_rgba(147,51,234,0.15)] transition-shadow duration-700 min-h-[800px] hover:z-50">
            {/* Glow effects */}
